...
def listing_searchable_text(instance):
    ...
    for obj in [instance] + instance.getDescendants():
        ...
        # self define
        entries.add(obj.getSubjectUID())
        entries.add(obj.getNucleicAcidType())
        entries.add(obj.getTissueType())
        entries.add(obj.getCancerType())
        entries.add(obj.getSampleClassification())
        entries.add(obj.getLibrary())

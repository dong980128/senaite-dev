...
class ILabProcess(Interface):
    """Marker interface for LabProcess
    """


class ILabTask(Interface):
    """Marker interface for LabTask
    """


class ILabProcessRun(Interface):
    """Marker interface for LabProcessRun
    """


class ILabTaskRun(Interface):
    """Marker interface for ILabTaskRun
    """

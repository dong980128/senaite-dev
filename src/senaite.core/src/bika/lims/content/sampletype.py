...
from bika.lims.browser.fields.customsamplingfield import CustomSamplingField
...
schema = BikaSchema.copy() + Schema((
    ...
    CustomSamplingField(
        ...
        widget=atapi.StringWidget(
            label=_("Custom Sampling Data"),
            description=_("Contains organized sampling data."),
        ),
    ),
))

...
from bika.lims.browser.widgets.mystringwidget import MyStringWidget
from bika.lims.browser.widgets.durationwidget import DurationWidget
from bika.lims.config import PRIORITIES, YES_NO
from bika.lims.config import YES_NO_NA
from bika.lims.config import ETHNICITY_VOCABULARY
from bika.lims.config import STORAGE_CONDITIONS
from bika.lims.config import LESION_TYPE_VOCABULARY
from bika.lims.config import TRANSPORT_METHOD
...
schema = BikaSchema.copy() + Schema((
    ...
    StringField(
        ...
        widget=MyStringWidget(
            label=_("label_subjectuid", default="Subject UID"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    UIDReferenceField(
        ...
        widget=ReferenceWidget(
            ...
            ui_item="Title",
            catalog=CONTACT_CATALOG,
            # Make custom query to handle parent client UID
            query={
                "getParentUID": "",
                "is_active": True,
                "sort_on": "sortable_title",
    ...
    StringField(
        ...
        read_permission=View,
        widget=MyStringWidget(
            label=_("label_hospital_patient_id", default=u"院内编码"),
            description=_("desc_hospital_patient_id",
                          default=u"该中心院内病人唯一识别码"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("label_diagnosis", default="Diagnosis"),
            visible={
                "add": "edit"
            },
            render_own_label=True
    ...
    #     required=False,
    #     storage=AttributeStorage(),
    #     vocabulary=COLLECTION_METHOD,
    #     widget=BikaSelectionWidget(
    #         format="select",
    #         label=_("label_collection_method", default="Collection Method"),
    #         visible={
    #             "add": "edit",
    #         },
    #         render_own_label=True,
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("label_ethnic_group", default="EthnicGroup"),
            visible={
                "add": "edit"
            },
            render_own_label=True
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("label_cancertype", default="Cancer Type"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("label_project_name", default="Project Name"),
            size=30,
            render_own_label=True,
            visible={
                "add": "edit",
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("label_samplecode", default="Sample Code"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    ARAnalysesField(
        ...
        widget=ComputedWidget(
            visible={
                ...
                'view': 'invisible',
                'sample_registered': {
                    'view': 'invisible', 'edit': 'invisible', 'add': 'invisible'},
            }
        ),
    ),
    ...
    DateTimeField(
        ...
        read_permission=View,
        widget=DateTimeWidget(
            label=_("label_true_date_received"),
            size=20,
            show_time=True,
    ...
    StringField(
        "LesionType",
        required=False,
        vocabulary=LESION_TYPE_VOCABULARY,
        widget=PrioritySelectionWidget(
            label=_("label_lesion_type", default="Lesion Type"),
            format="select",  # 显示为单选框
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        required=False,
        widget=MyStringWidget(
            label=_("label_lesion_description", default="Description"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        "TempControlledTransport",
        required=True,
        vocabulary=YES_NO,
        widget=PrioritySelectionWidget(
            label=_("label_temp_controlled_transport", default="Temperature-controlled transport?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    # 1. Thermometer validity
    StringField(
        "ThermometerStatus",
        required=False,
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_thermometer_status", default="Thermometer valid?"),
            description=_("desc_thermometer_status", default="Is the thermometer within the valid calibration period?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        "ThermometerCode",
        widget=MyStringWidget(
            label=_("label_thermometer_code", default="Thermometer Code"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_box_precooled", default="Box pre-cooled?"),
            description=_("desc_box_precooled", default="Was the box pre-cooled with ice packs before transport?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    # 3. Sample isolated in bubble wrap
    StringField(
        "SampleIsolated",
        required=False,
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_sample_isolated", default="Sample isolated in bubble wrap?"),
            description=_("desc_sample_isolated", default="Is the sample separated from ice packs using bubble wrap?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_box_padded", default="Padding used in box?"),
            description=_("desc_box_padded",
                          default="Was the box filled with padding to prevent movement during transport?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    # 5. Temperature 2–8°C recorded
    StringField(
        "TemperatureRecorded",
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_temp_recorded", default=u"Temp 2–8°C recorded?"),
            description=_("desc_temp_recorded", default=u"Did the thermometer show a temperature within 2–8°C?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        "TransportMethod",
        required=True,
        vocabulary=TRANSPORT_METHOD,
        widget=PrioritySelectionWidget(
            label=_("label_transport_method", default="Transport method"),
            description=_("desc_transport_method", default="How was the sample transported?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        required=True,
        widget=MyStringWidget(
            label=_("label_shipper", default="Shipper"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    DateTimeField(
        ...
        read_permission=View,
        widget=DateTimeWidget(
            label=_("label_shipping_time", default="Shipping Time"),
            size=20,
            show_time=True,
            visible={
                "view": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_o24h", default="Over 24h from collection?"),
            description=_("desc_o24h", default="Is it over 24 hours since sample collection?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_lblmatch", default="Label matches transfer info?"),
            description=_("desc_lblmatch",
                          default="Is the sample label consistent with the transfer form or email notification?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_pkgok", default="Packaging intact during transport?"),
            description=_("desc_pkgok",
                          default="Is the external packaging intact without any sign of being opened during transport?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_tempok", default=u"Temperature within 2–8℃ and logged?"),
            description=_("desc_tempok",
                          default=u"Was the transport temperature kept between 2–8℃ with real-time temperature records?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO_NA,
        widget=PrioritySelectionWidget(
            label=_("label_pkgstatus", default="Sample packaging normal?"),
            description=_("desc_pkgstatus",
                          default="Is the sample package intact without leakage, damage, or other abnormalities?"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    StringField(
        ...
        required=0,
        widget=MyStringWidget(
            label=_("label_pkgnote", default="Packaging abnormal note"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        searchable=True,
        storage=AttributeStorage(),
        vocabulary=STORAGE_CONDITIONS,
        widget=BikaSelectionWidget(
            format="select",
            label=_("label_storageconditions", default="Storageconditions"),
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("label_hlagenes", default="label_hlagenes"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("label_nucleicacidtype", default="label_nucleicacidtype"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("label_tissuetype", default="label_tissuetype"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        "Ethnicity",
        required=1,
        vocabulary="getEthnicityVocabulary",
        enforceVocabulary=False,  # 可以访问除列表之外的
        widget=PrioritySelectionWidget(
            label=_("label_ethnicity", default="Ethnicity"),
            format="select",
            allow_custom_values=True,  # 允许填写弹出编辑框
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        vocabulary=YES_NO,
        widget=PrioritySelectionWidget(
            label=_("label_blood_transfusion_12m", default=u"12个月内是否输血"),
            format="select",
            visible={
                "add": "edit",
                "edit": "visible",
    ...
    # 输血史（仅当12个月内是否输血为"是"时填写）
    StringField(
        "BloodTransfusionHistory",
        required=False,
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("label_blood_transfusion_history", default=u"输血史"),
            visible={
                "add": "edit",
                "edit": "visible",
                "view": "visible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("label_sampleclassification", default="label_sampleclassification"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("label_samplesource", default="label_samplesource"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("file_library", default="file_library"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("sample_name", default="sampleName"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        "LibrarySubmissionTime",
        storage=AttributeStorage(),
        schemata="Default",
        widget=MyStringWidget(
            label=_("Library Submission Time", default="LibrarySubmissionTime"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        schemata="Default",
        widget=MyStringWidget(
            label=_("Raw Data Path", default="Raw Data Path"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("Result Server Path", default="Result Server Path"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
    ...
    StringField(
        ...
        storage=AttributeStorage(),
        widget=MyStringWidget(
            label=_("Result Shared Path", default="Result Shared Path"),
            visible={
                "add": "invisible",
                "edit": "invisible",
                "view": "invisible",
...
schema.moveField('ProjectName', after='CancerType')
...
schema.moveField("Remarks", pos="bottom")
schema.moveField("TrueDateReceived", after='DateSampled')
schema.moveField('BloodTransfusion12M', after='Ethnicity')
schema.moveField('BloodTransfusionHistory', after='BloodTransfusion12M')
...
class AnalysisRequest(BaseFolder, ClientAwareMixin):
    ...
    def setPriority(self, value):
        ...
        if original_value != value:
            self.logFieldChange("Priority", original_value, value)  # 增加界面日志
    ...
    def getStorageConditions(self):
        return self.getField("StorageConditions").get(self)

    # 获取condition
    def get_condition_value(self, target_title):
        conditions = self.getServiceConditions()

        if not conditions:
            return ""
        for cond in conditions:
            title = cond.get("title", "").strip()
    ...
    def getHLAGenes(self):
        return self.get_condition_value(u"检测HLA基因")

    def getNucleicAcidType(self):
        return self.get_condition_value(u"核酸类型")

    def getTissueType(self):
        return self.get_condition_value(u"组织类型")

    def getSampleClassification(self):
        return self.get_condition_value(u"样本分类")

    def getSampleSource(self):
        return self.get_condition_value(u"样本来源")

    def getLibrary(self):
        return self.get_condition_value(u"文库名称")

    def getSampleName(self):
        return self.get_condition_value(u"样本名称")

    def getLibrarySubmissionTime(self):
        return self.get_condition_value(u"文库送测时间")

    def get_result_by_keyword(self, keyword):
        interim_fields = self.get('InterimFields', [])
    ...
    def update_custom_fields_from_results(self):
        """从分析结果更新自定义字段"""
        analyses = self.getAnalyses(full_objects=True)
        ...
        field_mapping = {
            ...
            'result_server_path': 'ResultServerPath',
            'result_shared_path': 'ResultSharedPath',
            'holdtime': "holdtime"
        }
        ...
        for analysis in analyses:
            # 获取分析服务的临时字段(interim fields)
            interim_fields = analysis.getInterimFields()

            # 检查每个临时字段
            for field in interim_fields:
                keyword = field.get('keyword', '')
                if keyword in field_mapping:
                    field_name = field_mapping[keyword]
                    field_obj = self.getField(field_name)
                    if field_obj is None:
                        logger.error("Field {} not found in schema!".format(field_name))
                        continue

                    value = field.get('value', '')
                    current_value = field_obj.get(self)

                    if str(current_value) != str(value):
                        field_obj.set(self, value)
                        updated = True
    ...
    def getRawDataPath(self):
        field = self.getField('RawDataPath')
        if field is None:
            logger.error("RawDataPath field not found in schema!")
            return None
        self.update_custom_fields_from_results()
        return field.get(self)

    def getResultServerPath(self):
        field = self.getField('ResultServerPath')
        if field is None:
            logger.error("ResultServerPath field not found in schema!")
            return None
        self.update_custom_fields_from_results()
        return field.get(self)

    def getResultSharedPath(self):
        """获取原始数据路径"""
        field = self.getField('ResultSharedPath')
        if field is None:
            logger.error("ResultSharedPath field not found in schema!")
            return None
        # 先尝试从分析结果更新字段值
        self.update_custom_fields_from_results()
        # 然后返回字段值
    ...
    def getholdTime(self):
        """获取领取时间"""
        field = self.getField('holdtime')
        if field is None:
            logger.error("holdtime field not found in schema!")
            return None
        self.update_custom_fields_from_results()
        return field.get(self)

    def logFieldChange(self, field_name, old, new):

        if not old or old == new:
            # logger.debug("[LOG] 字段 <%s> 没有变化，跳过记录", field_name)
            return

        # 获取现有历史快照
        history = self.getField("OldFieldSnapshot").get(self) or []

        now = DateTime()  # 当前时间
        now = now.toZone('Asia/Shanghai')  # 转换为上海时区
        now_str = now.strftime("%Y/%m/%d %H:%M:%S")

        username = api.get_current_user().getUserName()
        ...
        self.getField("OldFieldSnapshot").set(self, history)

    def setAndLog(self, field_name, new_value):
        field = self.getField(field_name)
        if not field:
            logger.warning("[SET] 字段 <%s> 不存在", field_name)
            return
        ...
        self.logFieldChange(field_name, old_value, new_value)

    def setDiagnosis(self, value):
        self.setAndLog("Diagnosis", value)

    def setCollectionMethod(self, value):
        self.setAndLog("CollectionMethod", value)

    def setCancerType(self, value):
        self.setAndLog("CancerType", value)

    def setBoxPreCooled(self, value):
        self.setAndLog("BoxPreCooled", value)

    def setSampleIsolated(self, value):
        self.setAndLog("SampleIsolated", value)

    def setSubjectUID(self, value):
        self.setAndLog("SubjectUID", value)

    def setHospitalPatientID(self, value):
        self.setAndLog("HospitalPatientID", value)

    def setSampleCode(self, value):
        self.setAndLog("SampleCode", value)

    # def setPriority(self, value):
    #     self.setAndLog("Priority", value)

    def setNumSamples(self, value):
        self.setAndLog("NumSamples", value)

    def setLesionType(self, value):
        self.setAndLog("LesionType", value)

    def setEthnicity(self, value):
        self.setAndLog("Ethnicity", value)

    def setLesionDescription(self, value):
        self.setAndLog("LesionDescription", value)

    def setTempControlledTransport(self, value):
        self.setAndLog("TempControlledTransport", value)

    def setThermometerStatus(self, value):
        self.setAndLog("ThermometerStatus", value)

    def setThermometerCode(self, value):
        self.setAndLog("ThermometerCode", value)

    def setBoxPadded(self, value):
        self.setAndLog("BoxPadded", value)

    def setTemperatureRecorded(self, value):
        self.setAndLog("TemperatureRecorded", value)

    def setTransportMethod(self, value):
        self.setAndLog("TransportMethod", value)

    def setShipper(self, value):
        self.setAndLog("Shipper", value)

    def setShippingTime(self, value):
        self.setAndLog("ShippingTime", value)

    def setStorageConditions(self, value):
        self.setAndLog("StorageConditions", value)

    def setOver24h(self, value):
        self.setAndLog("over24h", value)

    def setLabelMatch(self, value):
        self.setAndLog("labelMatch", value)

    def setPkgIntact(self, value):
        self.setAndLog("pkgIntact", value)

    def setTempValid(self, value):
        self.setAndLog("tempValid", value)

    def setPkgStatus(self, value):
        self.setAndLog("pkgStatus", value)

    def setPkgStatusNote(self, value):
        self.setAndLog("pkgStatusNote", value)

    def setBloodTransfusion12M(self, value):
        self.setAndLog("BloodTransfusion12M", value)

    def setBloodTransfusionHistory(self, value):
        self.setAndLog("BloodTransfusionHistory", value)

    def getEthnicityVocabulary(self):
        """base vocab + current value"""
        base = list(ETHNICITY_VOCABULARY)
        current = self.getEthnicity()
        if current and current not in base:
            base.append(current)
        return DisplayList([(v, v) for v in base])

    ...
    _properties.update({
        ...
        "subfield_vocabularies": {
            "result_type": DisplayList((
                ...
                ("tiered_multivalue", _(u"多值(单字段)")),  # 病理实验数据存储字段
                ("posneg_with_note", _(u"阳性/阴性/未检（阳性可填备注）")),  # qpcR
                ("file", _(u"文件上传")),
                ("tcr_selector", _(u"TCR序列选择器")),
                ("tcr_preparation", _(u"TCR制备列表")),
                ("tick", _(u"True or False")),
                ("tcr_scaffold", _(u"TCR骨架制备列表")),
                ("tcr_plasmid", _(u"TCR质粒列表")),
            )),
        },
    })
